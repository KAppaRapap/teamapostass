...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Criar Novo Grupo</h2>
        ...
        <div class="card-body">
            <form action="{{ route('groups.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('max_members') is-invalid @enderror" id="max_members" name="max_members" value="{{ old('max_members') }}" min="0">
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input class="form-check-input @error('is_public') is-invalid @enderror" type="checkbox" id="is_public" name="is_public" value="1" {{ old('is_public') ? 'checked' : '' }}>
